...
int main() try {
  ...
  c.begin(); {
    ...
    //   c.beginBlock("entry"); {
    // 	auto args = c.constructFunctionArguments(values::i8(12));
    // 	c.callFunction("fib", "end", args, "f");
    //   } c.endBlock();
    ...
    // 	auto args = c.constructFunctionArguments(n_minus_1);
    // 	c.callFunction("fib", "recurse2",  args, "f1");
    //   } c.endBlock();

    //   c.beginBlock("recurse2"); {
    // 	// fib(n - 2)
    // 	auto n_minus_2 = c.sub("n", values::i8(2));
    // 	auto args = c.constructFunctionArguments(n_minus_2);
    // 	c.callFunction("fib", "end", args, "f2");
    //   } c.endBlock();
