...
c.function("main").begin(); {
  ...
  c.write(c.add(c.lnot("a"), literal::i8('A')));
  ...
  c.write(c.add(c.lnot("x"), literal::i8('A')));
  ...
  c.write(c.add(c.lnot(literal::i8(0)), literal::i8('A')));

  // 6. i8 literal: NOT true -> false
  c.write(c.add(c.lnot(literal::i8(77)), literal::i8('A')));

  // 7. i16 literal: NOT false -> true
  c.write(c.add(c.lnot(literal::i16(0)), literal::i8('A')));

  // 8. i16 literal: NOT true -> false
  c.write(c.add(c.lnot(literal::i16(0xBEEF)), literal::i8('A')));
  ...
  c.lnotAssign("y");
  c.write(c.add(c.eq("y", literal::i16(0)), literal::i8('A')));
