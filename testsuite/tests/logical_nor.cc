...
c.function("main").begin(); {
  ...
  c.write(c.add(c.lnor("a", "b"), literal::i8('A')));
  ...
  c.write(c.add(c.lnor("x", "y"), literal::i8('A')));
  ...
  c.write(c.add(c.lnor("a", "x"), literal::i8('A')));

  // 6. variable + literal: true NOR false -> 0
  c.assign("a", literal::i8(0x66));
  c.write(c.add(c.lnor("a", literal::i8(0)), literal::i8('A')));

  // 7. literal + variable: true NOR true -> 0
  c.assign("x", literal::i16(0x2345));
  c.write(c.add(c.lnor(literal::i16(0x7777), "x"), literal::i8('A')));

  // 8. literal + literal, constant-folded: true NOR false -> 0
  c.write(c.add(c.lnor(literal::i16(0x9999), literal::i16(0)), literal::i8('A')));
