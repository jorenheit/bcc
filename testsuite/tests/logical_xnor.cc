...
c.function("main").begin(); {
  ...
  c.write(c.add(c.lxnor("a", "b"), literal::i8('A')));
  ...
  c.write(c.add(c.lxnor("x", "y"), literal::i8('A')));
  ...
  c.write(c.add(c.lxnor("a", "x"), literal::i8('A')));

  // 6. variable + literal: true XNOR false -> 0
  c.assign("a", literal::i8(0x66));
  c.write(c.add(c.lxnor("a", literal::i8(0)), literal::i8('A')));

  // 7. literal + variable: true XNOR true -> 1
  c.assign("x", literal::i16(0x2345));
  c.write(c.add(c.lxnor(literal::i16(0x7777), "x"), literal::i8('A')));

  // 8. literal + literal, constant-folded: true XNOR false -> 0
  c.write(c.add(c.lxnor(literal::i16(0x9999), literal::i16(0)), literal::i8('A')));
